...
public class JSONUtils
{
    ...
    public static String getValueByJsonKey(String jsonStr, String key) {
	...
	public static List jsonToList(String jsStr , Class clz){
		if(jsStr ==null){
			return null;
		}
		JSONArray jsary = (JSONArray) JSONSerializer.toJSON(jsStr);
		@SuppressWarnings({ "deprecation" })
		List list  = JSONArray.toList(jsary, clz); 
		return list;
	}
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public static List jsonToListByKey(String jsStr, String key){
		List list = new ArrayList();
		try{
			JSONObject jsonObj = (JSONObject)JSONSerializer.toJSON(jsStr);
			JSONArray jsonAry = (JSONArray)jsonObj.get(key);
	...
	public static String listToJson(@SuppressWarnings("rawtypes") List list){
		JSONArray js = (JSONArray)JSONSerializer.toJSON(list);
		return js.toString();
	}
	...
	public static void main(String[] args){
		...
		List jo2 =JSONUtils.jsonToListByKey(string, "spid");// (JSONArray)jo.get("spid");
		for(Object i : jo2){
