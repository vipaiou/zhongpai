...
<a href="<s:url value="/"/>" class="logo"><img src="<s:url value="/demohour-index_files/logo-5af45a5a816b116ece5ae45f49c0f1d7.png" />" title="众拍网"></a>
<div class="head-l">
<div class="head-l-menu">
<%-- <a href="<s:url value="/"/>" class="menu-h">首页</a> --%>
<a href="<s:url value="/projects"/>" class="menu-p">城市<br/>Coz Cafe</a>
<a href="<s:url value="/projects"/>" class="menu-p">聚集<br/>编剧社</a>
<a href="<s:url value="/projects"/>" class="menu-p">商城<br/>众拍汇</a>
<a href="<s:url value="/projects"/>" class="menu-p">浏览项目</a>
<a href="<s:url value="/projects/new"/>" class="menu-n">发起项目</a>
</div>
</div>
...
<ul class="menulist" style="display:none;">
<li class="toplines"><img src="<s:url value="/demohour-index_files/toplines-77db07bc10a3e6f451da4b801840616c.gif" />"></li>
<li><a href="<s:url value="/topic/"/>">我的话题</a></li>
<li><a href="<s:url value="/comment/"/>">我的评论</a></li>
<li><a href="<s:url value="/message/"/>">我的私信</a></li>
<li><a href="<s:url value="/notification/"/>">站内通知</a></li>
</ul>
</li>
...
<li><a href="<s:url value="/user/profile"/>">帐号设置</a></li>
<li><a href="<s:url value="/user/home"/>" target="_blank">个人主页</a></li>
</ul>
</li>
