...
<li><a href="<%=request.getContextPath() %>/projects/created" class="ui-tab-current">发起的 <span>2</span></a></li>
<li><a href="<%=request.getContextPath() %>/projects/backed">支持的 <span>0</span></a></li>
<li><a href="<%=request.getContextPath() %>/projects/favorite">关注的 <span>1</span></a></li>
</ul>
</div>
</div>
...
<div class="my-progress-title">准备中的项目</div>
...
<td valign="middle">${project.status}</td>
<td valign="middle">
<a href="<%=request.getContextPath()%>/projects/edit/${project.id}">修改</a>
<span>&nbsp;|&nbsp;</span>
<a href="<%=request.getContextPath()%>/projects/delete/${project.id}" class="ui-popup-delete" rel="nofollow" title="确认要删除这个项目？">删除</a>
</td>
</tr>
</c:forEach>
</tbody></table>
