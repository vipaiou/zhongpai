...
<li><a href="<%=request.getContextPath()%>/message/received/" class="ui-tab-current">发送给我的</a></li>
</ul>
</div>
</div>
...
<div class="private-letter-list-t-l">发送给 我</div> 
<%-- <a href="<%=request.getContextPath()%>/user/${message.from}" target="_blank">${message.tousername }</a> --%>
: ${message.content }
</div>
...
<a href="<%=request.getContextPath()%>/message/detail?with=${message.from}">共${message.messagecount }条对话</a><span>|</span>
<a href="<%=request.getContextPath()%>/messages?recipient_id=${message.from}" class="ui-popup-message" title="回复给 ${message.fromusername }">回复</a><span>|</span>
<a href="<%=request.getContextPath()%>/messages/all?contact_id=${message.from}" class="ui-popup-delete" rel="nofollow" title="确定要删除与 ${message.fromusername } 之间的这条私信？">删除</a>
</div>
</div>
</li>
</c:forEach>
