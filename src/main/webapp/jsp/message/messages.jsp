...
<div class="ui-tab">
<div class="categories-top">我的私信</div>
</div>
...
<li id="contact_184941"><a href="<%=request.getContextPath()%>/1121568" target="_blank" class="private-letter-list-l"><img src="<%=request.getContextPath()%>/demohour-index_files/user_avatars-files-000-106-730-106730-small.jpg"></a>
<div class="private-letter-list-r">
<div class="private-letter-list-t">
<div class="private-letter-list-t-l">发送给</div> <a href="<%=request.getContextPath()%>/1121568" target="_blank">aiou</a>
: wohao
</div>
<div class="private-letter-list-b">
<span class="private-letter-list-date" data-timestamp="2013-09-01 22:35:26 +0800">1分钟以前</span><a href="<%=request.getContextPath()%>/message/detail">共2条对话</a><span>|</span>
<a href="<%=request.getContextPath()%>/messages?recipient_id=1121568" class="ui-popup-message" title="回复给 aiou">回复</a><span>|</span>
<a href="<%=request.getContextPath()%>/messages/all?contact_id=184941" class="ui-popup-delete" rel="nofollow" title="确定要删除与 aiou 之间的所有私信？">删除</a>
</div>
</div>
</li>
</ul>
