...
<li><a class="ui-tab-current" href="<%=request.getContextPath()%>/notification/notread">未读通知<span>0</span></a></li>
<li><a href="<%=request.getContextPath()%>/notification/read">全部通知</a></li>
</ul>
</div>
</div>

<div class="nocontent">目前还没有任何未读通知</div>
