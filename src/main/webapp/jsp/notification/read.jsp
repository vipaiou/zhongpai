...
<li><a href="<%=request.getContextPath()%>/notification/notread">未读通知<span>0</span></a></li>
<li><a class="ui-tab-current" href="<%=request.getContextPath()%>/notification/read">全部通知</a></li>
</ul>
</div>
</div>

<div class="content ui-dropboxlist">
<ul>
<li id="notification_8571750" class="ui-dropboxlistoff" onmouseout="this.className='ui-dropboxlistoff'" onmouseover="this.className='ui-dropboxliston'"><a href="<%=request.getContextPath()%>/notifications/8571750">很抱歉，「社交网api整合」未通过审核，请调整后再次提交</a><span>2013-08-30</span><p><a href="<%=request.getContextPath()%>/notifications/8571750" data-method="delete" data-remote="true" rel="nofollow">删除</a></p></li>
</ul>
