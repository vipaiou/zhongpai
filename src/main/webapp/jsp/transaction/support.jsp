...
<li><a class="ui-tab-current" href="<%=request.getContextPath()%>/transaction/">订单管理</a></li>
<li><a href="<%=request.getContextPath()%>/transaction/credit">收支明细</a> </li>
...
<div class="account-balance-t"><p>账户余额<span id="credit_total" class="yuan"><b>¥</b>0.00</span>元</p></div>
<div class="account-balance-b"><p>充值到众拍网，方便支持项目！ </p>
<a href="<%=request.getContextPath()%>/credits/new">立即充值</a>
</div>
</div>
</div>
<div class="content support-projects-list">
<div class="nocontent">目前还没有支持任何项目，<a href="<%=request.getContextPath()%>/projects">点击这里</a> 发现更多有趣的项目</div>
<div class="ui-pagination"><ul></ul></div>
</div>
<div id="shipping_popup" class="ui-popup" style="display:none">
...
<td class="ui-popup-top"><span>快递查询</span></td>
...
<table class="operate-express-queries" border="0" cellpadding="0" cellspacing="0">
<tbody><tr>
<td id="express_name" align="right" valign="top" width="100">快递：</td>
<td align="left" valign="top"><div class="operate-express-numbers" id="express_no"></div><div class="operate-btn">
<a id="express_url" href="" target="_blank" class="ui-button-operate-green">跟踪回报</a>
</div></td>
</tr>
<tr>
<td align="right" height="30" valign="top" width="100">收货地址：</td>
<td id="shipping_address" align="left" valign="top"></td>
</tr>
</tbody></table>
</td>
...
<tr><td class="ui-popup-mid-l"></td>
<td class="ui-popup-mid">
<p class="ui-popup-text">确认？</p>
<div class="ui-button-green ui-button"><span><a class="ui-popup-url" href="#" data-remote="true" rel="nofollow">确定</a></span></div>
...
//<![CDATA[
$(document).ready(function(){$.ui_core.ready('dropbox', 'tab', 'popup', 'button', 'checkbox', 'radio', 'text', 'action', 'popup_preview');$('input, textarea').placeholder();$(window).scroll(function(){if($(window).scrollTop() > 48){$('#ui_notification').addClass('layer-message-fixed');}else{$('#ui_notification').removeClass('layer-message-fixed');}});$.ui_notification.ready({url:'http://nf-2.demohour.com',data:{"new_comments_count":0,"new_messages_count":0,"new_notifications_count":0,"new_posts_count":0}});$("#action_status").change(function(){window.location.href="/transactions?status=all".replace("all",$(this).val())}),$.ui_core.select("action_status",""),$("a.ui-popup-open").click(function(t){$("#express_name").html($(t.target).attr("data-express-name")+"快递："),$("#express_no").html($(t.target).attr("data-express-no")),$("#express_url").attr("href",$(t.target).attr("data-express-url")),$("#shipping_address").html($(t.target).attr("data-shipping-address"))}),$("body").on("click","a.ui-popup-confirm",function(t){$("#ui_popup_confirm").find("div.ui-popup-content").css("top",$(window).height()/2-80),$("#ui_popup_confirm").find("p.ui-popup-text").html($(t.target).attr("title")),$("#ui_popup_confirm").find("a.ui-popup-url").attr("href",$(t.target).attr("href")),$("#ui_popup_confirm").find("a.ui-popup-url").attr("data-method",$(t.target).attr("data-method")),$("#ui_popup_confirm").toggle(),t.preventDefault()}),$("body").on("click","a.ui-popup-delete",function(t){$("#ui_popup_delete").find("div.ui-popup-content").css("top",$(window).height()/2-120),$("#ui_popup_delete").find("p.ui-popup-text").html($(t.target).attr("title")),$("#ui_popup_delete").find("a.ui-popup-url").attr("href",$(t.target).attr("href")),$("#ui_popup_delete").toggle(),t.preventDefault()}),$("body").on("click","a.ui-popup-message",function(t){$("#ui_popup_message").find("div.ui-popup-content").css("top",$(window).height()/2-150),$("#ui_popup_message").find("form").attr("action",$(t.target).attr("href")),$("#ui_popup_message").find("span.ui-popup-title").html($(t.target).attr("title")),$("#ui_popup_message").toggle(),$("#ui_popup_message").find("textarea").val($(t.target).attr("data-message-attachment")),$("#ui_popup_message").find("textarea").focus(),$(t.target).attr("href").indexOf("?recipient_id=")>0?($("#ui_popup_message_url").show(),$("#ui_popup_message_email").hide(),$("#ui_popup_message_url").find("a").attr("href",$(t.target).attr("href").replace("?recipient_id=","/"))):($("#ui_popup_message_url").hide(),$("#ui_popup_message_email").show()),t.preventDefault()});;$.ui_core.backtop('#backtop');$.ui_core.distance({now:'2013-09-01 22:48:40 +0800'});});
var _gaq = _gaq || [];
