...
<li><a class="ui-tab-current" href="<%=request.getContextPath()%>/transaction/recharge">帐户充值</a> </li>
</ul>
</div>
</div>
...
<ul>
<li>
<label for="address_name">充值金额 ：</label>
<div class="ui-text">
<div class="ui-text-right">
<input id="credit_income" name="credit[income]" autocomplete="off" placeholder="" type="text">
</div>
</div>
<span class="sm">人民币（元）</span>
</li>
</ul>
<div class="cash-button-b">
<div id="confirm_button" class="ui-button ui-button-green"><span><button type="submit">确认，去付款</button></span></div>
</div>
</div>
</form></div>
